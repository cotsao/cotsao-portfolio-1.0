<template>
  <div class="bg-black text-iron">
    ...
    <main class="w-full px-6 mx-auto mt-36 lg:mt-0 lg:px-36">
      ...
      <section id="employment" class="w-full px-8 mx-auto lg:px-48 lg:py-40 lg:mb-30">
        <h2
          class="text-2xl transform translate-y-6 opacity-0 numbered-heading lg:text-3xl employment-section"
        >
          Employment
        </h2>
        <div class="mt-8 space-y-8 transform translate-y-4 opacity-0 employment-section">
          ...
          <div class="relative pl-6 border-l-2 border-mariner">
            ...
            <ul class="space-y-1 text-sm list-disc list-inside text-iron-400">
              ...
              <li>Created CLI wrapper with abstraction layer enabling unified control from single interface</li>
              <li>Designed scalable architecture supporting both control and recording computer deployments</li>
            </ul>
          </div>
          ...
          <div class="relative pl-6 border-l-2 border-mariner">
            ...
            <ul class="space-y-1 text-sm list-disc list-inside text-iron-400">
              ...
              <li>Delivered critical projects under tight deadlines during launch preparation</li>
            </ul>
          </div>
          ...
          <div class="relative pl-6 border-l-2 border-mariner">
            ...
            <ul class="space-y-1 text-sm list-disc list-inside text-iron-400">
              ...
              <li>Built difference viewer for code editor and web-based image editor for robot maps</li>
              <li>Automated manual workflows, reducing site processing time by several hours</li>
              <li>Redesigned application UIs based on user feedback to improve workflow efficiency</li>
            </ul>
          </div>
        </div>
      </section>
...
export default {
  ...
  mounted() {
    const { setupNavAnimation, aboutPageAnimations } = useAnimations();
    setupNavAnimation();
    aboutPageAnimations();
  },
  head() {
